...
export const Analytics = () => {
  return (
    <div className='flex w-full h-full gap-5 pb-10'>
      <div className='flex flex-col h-full w-5/12 overflow-y-scroll no-scrollbar gap-5'>
        <Cities />
        <div className='h-1/2 w-full bg-second-primary rounded-xl p-5'>
          <h1 className='font-bold text-3xl'>plugins</h1>
        </div>
      </div>
      <div className='flex flex-col h-full w-7/12 overflow-y-scroll no-scrollbar gap-5'>
